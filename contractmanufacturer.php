...
<section class="page_breadcrumbs_Manufacturer ds color parallax section_padding_top_75 section_padding_bottom_75">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <ol class="breadcrumb highlightlinks">
                    ...
                    <li class="active">Contract Manufacturer</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
               <h2 class="section_header">Top Pharmaceutical Contract Manufacturer In India</h2>
                <p><b>MyGenic Healthcare Pvt. Ltd.</b> is a leading pharmaceutical contract manufacturer in India. This means that the company manufactures pharmaceutical products on a contract basis for other companies or clients.</p>
...
<section class="ls section_padding_top_150 section_padding_bottom_150">
  <div class="container" style="padding-bottom:0px;">
        <div class="row">
            <div class="col-sm-6">
               <h2 class="section_header">Why To Choose Us?</h2>
                <p>We at <b>MyGenic Healthcare Private Limited</b> offer high-quality pharmaceutical products that meet industry standards and regulations. We use advanced technologies and processes to ensure that our products are safe and effective.</p>
