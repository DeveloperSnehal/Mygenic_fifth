...
<section class="page_breadcrumbs_How-We-Do ds color parallax section_padding_top_75 section_padding_bottom_75">
    <div class="container">
        <div class="row">
...
<section class="ls section_padding_top_150 section_padding_bottom_150">
  <div class="container" style="padding-bottom:0px;">
        <div class="row">
            ...
            <div class="col-sm-6">
               <h2 class="section_header">Raw Material</h2>
                ...
                <p><b>APIs</b> are the primary raw materials in drug formulation. They are chemically active substances that have a direct impact on the treatment of a specific disease or condition. <b>Excipients</b> are non-active substances used in drug formulation alongside APIs. <b>Solvents</b> are used during the manufacturing process to dissolve APIs and excipients, facilitating their combination and formulation into a final dosage form.</p>
...
<section class="ls section_padding_top_150 section_padding_bottom_150">
  <div class="container" style="padding-bottom:0px;">
        <div class="row">
            <div class="col-sm-6">
               <h2 class="section_header">Manufacturing</h2>
...
<section class="ls section_padding_top_150 section_padding_bottom_150">
  <div class="container" style="padding-bottom:0px;">
        <div class="row">
            ...
            <div class="col-sm-6">
               <h2 class="section_header">Storage</h2>
...
<section class="ls section_padding_top_150 section_padding_bottom_150">
  <div class="container" style="padding-bottom:0px;">
        <div class="row">
            ...
            <div class="col-sm-6">
              <img src="images\how we do\transport.png" alt="">
            </div>
        </div>
    </div>
</section>
...
<section class="ls section_padding_top_150 section_padding_bottom_150">
  <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
               <h2 class="section_header">Export</h2>
                <p>Export in the pharmaceutical industry refers to the process of selling and distributing
                    pharmaceutical products to foreign markets or countries outside the company's home country.
                    Pharmaceutical exports play a significant role in expanding the reach of pharmaceutical companies,
                    accessing new markets, and meeting the healthcare needs of diverse populations.</p>
                <p><b>Cold Chain Export:</b> Cold chain export refers to the transportation of temperature-sensitive
                    products, including pharmaceuticals, in a controlled and temperature-monitored environment
                    throughout the export process. It involves maintaining the required temperature range from the point
                    of origin to the final destination to ensure the integrity and efficacy of the products.</p>
                <p><b>Normal Export:</b> Normal export refers to the without specific temperature controls or
                    requirements. It typically involves shipping products that are stable at ambient temperatures and do
                    not require specialized temperature-controlled packaging or transport.</p>
            </div>
        </div>
    </div>
</section>
